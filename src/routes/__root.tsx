...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Compra entradas para todos los eventos culturales de Alburquerque." },
      { name: "author", content: "Ayuntamiento de Alburquerque" },
      { name: "theme-color", content: "#6b1f1a" },
      { property: "og:title", content: "Alburquerque Cultural — Entradas y Eventos del Ayuntamiento" },
      { property: "og:description", content: "Compra entradas para todos los eventos culturales de Alburquerque." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Alburquerque Cultural — Entradas y Eventos del Ayuntamiento" },
      { name: "twitter:description", content: "Compra entradas para todos los eventos culturales de Alburquerque." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/TOIUoTgaz0XShvFLo2f733KpGsv2/social-images/social-1783672757648-ayunta_albur.webp" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/TOIUoTgaz0XShvFLo2f733KpGsv2/social-images/social-1783672757648-ayunta_albur.webp" },
    ],
    links: [
